  ...
  return (
    <>
      <LogOutContext.Provider value={{ isLogOutOpened, logOutToggle }}>
        <div className="z-50 flex h-auto w-full flex-col items-start gap-[16px] bg-darker py-4 max-lg:gap-0 max-lg:py-0 lg:my-0 lg:h-24 lg:w-full lg:flex-row lg:items-center">
